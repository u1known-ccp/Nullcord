...
<#
    ...
    Patches your local Discord desktop client to load NullCord from this repo's
    ...
    Uninstall with installer\NullCord-Uninstall.ps1.
#>
...
'@ | Set-Content -Path (Join-Path $appDir "package.json") -Encoding utf8
    ...
    # index.js loads the NullCord patcher; the patcher itself loads the original Discord.
