...
export default definePlugin({
    name: "GameMode",
    description: "Eases off NullCord's visual effects (animations, blur, the pet, cursor buddies) while Discord is in the background, so your games and other apps run smoother.",
