...
export const ASSET_ENDPOINT = "https://NullCord-analytics.hell-bullet-hb.workers.dev";
...
export function themeFileName(params: StudioParams): string {
    return `NullCord Studio - ${params.name}.theme.css`;
}
...
export function generateCss(params: StudioParams): string {
    ...
    return `/**
 * @name ${params.name}
 * @author NullCord Studio
 * @description Made with NullCord Studio — colors, roundness and sparkles, no CSS needed.
 * @version 1.0.0
 * @website https://NullCord.dev
*/
