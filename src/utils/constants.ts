...
// Equicord
export const SUPPORT_CHANNEL_ID = "1521977073319543015";
export const GUILD_ID = "1456674008237084715";
export const DONOR_ROLE_ID = "1521976741927583744";
export const CONTRIB_ROLE_ID = "1521976719089602560";
export const EQUICORD_TEAM = "1521976802971615353";
export const EQUICORD_HELPERS = "1521976791596798145";
export const VENCORD_CONTRIB_ROLE_ID = "1173343399470964856";
export const EQUIBOT_USER_ID = "1515724707024867438";
export const KNOWN_ISSUES_CHANNEL_ID = "1521977009868378284";
...
export const GUILD_IDS = [GUILD_ID];
