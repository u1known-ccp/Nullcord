        ...
        setTimeout(() => {
            try {
                ...
                for (const guildId in guilds) {
                    ...
                    // getChannels() returns ALL channels of the server
                    // (including ones without permission) — exactly like the Discord gateway
...
function VoiceSearchModal({ rootProps, channels }: { rootProps: any; channels: VoiceChannel[] | null; }) {
    ...
    async function join(ch: VoiceChannel) {
        ...
        try {
            ...
            // Small delay for the visual effect before closing
